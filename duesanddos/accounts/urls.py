...
urlpatterns = [
    ...
    path("expenses/delete/<int:expense_id>/", views.delete_expense_pro, name="delete_expense_pro"),
    path("expenses/edit/<int:expense_id>/", views.edit_expense_pro, name="edit_expense_pro"),
